...
// This file - min.h - contains the class definition of the Min class, which is a subclass of SubExpression,
...
// by returning the min of the values of the two subexpressions.
...
public:
    ...
    double evaluate()  {
       return ( left->evaluate() < right->evaluate() ) ? left->evaluate() : right->evaluate() ;   // return min
    }
};