...
// This file - exponent.h - contains the class definition of the Exponent class, which is a subclass of SubExpression,
...
// by returning the exponent of the values of the two subexpressions.
...
public:
    ...
    double evaluate()  {
	   return pow(left->evaluate(), right->evaluate());               // return exp
    }
};