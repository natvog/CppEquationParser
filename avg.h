...
// This file - avg.h - contains the class definition of the Avg class, which is a subclass of SubExpression,
...
public:
    ...
    double evaluate()  {
       return ( left->evaluate() + right->evaluate() ) / 2;    // return average
    }
};